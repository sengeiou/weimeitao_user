package com.wmtc.chatmodule.widget;
...
import com.wmtc.chatmodule.util.AudioRecoderUtils;
import com.wmtc.chatmodule.util.MessageConst;
import com.wmtc.chatmodule.util.PopupWindowFactory;
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                message.content = mEditText.getText().toString();
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(long time, String filePath) {
                ...
                messageInfo.setVoiceTime(time / 1000);
                EventBus.getDefault().post(messageInfo);
                //todo messageBaseInfo
                VoiceMessage message = new VoiceMessage();
                message.leftOrRight = MessageConst.TYPE_RIGHT;
                message.voiceSecond = time / 1000;
