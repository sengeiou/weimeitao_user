 ...
 */
public class FollowsListAdapter extends BaseQuickAdapter<FansListBean.DataBean, BaseViewHolder> {


    public FollowsListAdapter(List<FansListBean.DataBean> data) {
