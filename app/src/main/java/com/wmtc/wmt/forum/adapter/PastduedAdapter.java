...
public class PastduedAdapter extends BaseQuickAdapter<DiscountsBean.DataBean.ListBean, BaseViewHolder> {

    public PastduedAdapter(List<DiscountsBean.DataBean.ListBean> data) {
        super(R.layout.item_pastdue, data);
    }
