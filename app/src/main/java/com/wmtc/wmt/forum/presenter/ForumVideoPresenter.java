...
import com.wmtc.wmt.forum.activity.ForumVideoSendActivity;
 ...
 */
public class ForumVideoPresenter extends BasePresenter<ForumVideoSendActivity> {

    private final CommonModel mModel;

    public ForumVideoPresenter(ForumVideoSendActivity iView) {
        super(iView);
    ...
    public void saveVideo(SendPojo pojo) {
        mModel.saveVideo(pojo).subscribe(new DefaultCallBackObserver<BaseBean>(this) {
            @Override
