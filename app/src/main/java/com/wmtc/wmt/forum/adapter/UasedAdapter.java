...
public class UasedAdapter extends BaseQuickAdapter<DiscountsBean.DataBean.ListBean, BaseViewHolder> {

    public UasedAdapter(List<DiscountsBean.DataBean.ListBean> data) {
        super(R.layout.item_used, data);
    }
