 ...
 */
public class SaveReasonPresenter extends BasePresenter<SaveAfterSaleActivity> {

    private final CommonModel mModel;

    public SaveReasonPresenter(SaveAfterSaleActivity iView) {
        super(iView);
    ...
    public void saveAfterSale(SaveAfterSalePojo pojo) {
        mModel.saveAfterSale(pojo)
                .subscribe(new DefaultCallBackObserver<BaseBean>(new LoaddingErrorImplTip(mIView), this) {
                    @Override
                    public void responseSuccess(BaseBean baseBean) {
                        mIView.saveAfterSale();
                    }
